...
# Label Path
ex_labels_path = "/content/drive/MyDrive/Segmentation/All Segmentation Groundtruths/Testing Set/Hard Exudates/"
...
#img_ex_patch = nearest_neighbor_resize(img_ex)
...
#img_both = cv2.bitwise_or(img_ex,img_ex_patch_half)
# Bitwise Operation of the above patch and the eroded lightness patch
img_both = cv2.bitwise_and(img_ex_patch,img_erode)
